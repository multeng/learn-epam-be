...
import { CreateUserRequstSchema, UpdateUserRequstSchema } from '../middlewares/usersValidator';

export const create = async (req: ValidatedRequest<CreateUserRequstSchema>, res: Response) => {
...
export const update = async (req: ValidatedRequest<UpdateUserRequstSchema>, res: Response) => {
  const { id } = req.params;
